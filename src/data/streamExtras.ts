...
export const STREAM_EXTRAS: Record<StreamSlug, StreamExtra> = {
  ...
  medicine: {
    why: {
      ...
      cards: [
        { icon: Globe2, title: '100% English-Medium', text: 'MBBS / M.D. is taught fully in English at universities where ABHA assists admissions — no local-language barrier to study.' },
  ...
  dentistry: {
    why: {
      ...
      titleAccent: 'Georgia',
      cards: [
        { icon: Globe2, title: '100% English-Medium', text: 'The Doctor of Dental Medicine (DMD) programme is taught fully in English at universities where ABHA assists admissions.' },
        { icon: FileCheck, title: 'Accredited Universities', text: 'Universities where ABHA assists admissions are accredited by the Ministry of Education and Science of Georgia.' },
        ...
        { icon: Handshake, title: 'Universities Where ABHA Assists', text: 'Admission guidance through ABHA at SEU, European University and the University of Georgia.' },
      ],
    },
    comparison: {
      kicker: 'An Honest Comparison',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Is the medium of instruction English?', a: 'Yes, the DMD programme at universities where ABHA assists admissions is delivered in English.' },
      ],
    },
  },
  ...
  'nursing-health-sciences': {
    why: {
      ...
      titleAccent: 'Georgia',
      cards: [
        { icon: Globe2, title: '100% English-Medium', text: 'BSc Nursing and Pharmacy programmes are taught in English at universities where ABHA assists admissions.' },
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'What are the fees?', a: 'Verified year-wise tuition is shown in the fee chart above. Hostel, food and living costs are extra unless stated.' },
        { q: 'Is the course in English?', a: 'Yes, the programmes at universities where ABHA assists admissions are delivered in English.' },
  ...
  'it-data-science-ai': {
    why: {
      ...
      cards: [
        ...
        { icon: Handshake, title: 'International Partnerships', text: 'Exchange and international-partnership opportunities at universities where ABHA assists admissions.' },
      ],
    },
    comparison: {
      kicker: 'An Honest Comparison',
