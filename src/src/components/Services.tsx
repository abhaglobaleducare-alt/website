...
const services = [
  ...
  },
  {
    ...
    description:
      'Georgia: Sterling Study & Stay Suites in Tbilisi (200+ beds, fully furnished, warden-managed). Kyrgyzstan: Managed student housing with 24/7 security. Not third-party — ours.',
    color: '#C6962E',
  },
  {
    icon: Utensils,
