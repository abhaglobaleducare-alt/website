...
const reasons = [
  {
    ...
    description:
      'You live in our management hostels and facilities - not some random landlords flat out or Hostels.',
  },
  {
    icon: Utensils,
  ...
  {
    icon: BookOpen,
    title: 'Clinical Workshops by our Partners INCREDOC',
    description:
  ...
  },
  {
    ...
    description:
      'Kolhapur head office, Chatrapati Sambhajinagar branch, and a full office in Tbilisi, Georgia. Real people in real offices, not just a WhatsApp number.',
  },
  {
    icon: Users,
