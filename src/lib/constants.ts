...
export const SITE_CONFIG = {
  ...
  description:
    'ABHA Global Educare LLP — premier MBBS abroad consultancy for Indian students. NMC & WHO Eligible universities in Georgia, Timor-Leste & the Russian countries. NEET preparation portal, full mock tests, and Bapusaheb Patil (Sagaon) Global Education Support Grant. Office in Kolhapur, Maharashtra.',
...
export const FOOTER_LINKS = {
  ...
  destinations: [
    ...
    { label: 'MBBS in Timor-Leste', href: '/destinations/timor-leste' },
    { label: 'MBBS in Russian Countries', href: '/destinations/russian-countries' },
...
export const DESTINATIONS = [
  ...
  {
    id: 'russian-countries',
    name: 'Russian Countries',
    flag: '🇷🇺',
    image: '/images/destinations/bosnia.jpg',
    universities: 20,
    duration: '6 years',
    fees: 'Speak to a counsellor',
    recognition: 'NMC & WHO Eligible',
    highlights: [
      'Established state medical universities',
      'English-medium programs',
      'Large Indian student community',
      'Affordable, well-supported route',
    ],
  },
  {
    id: 'philippines',
